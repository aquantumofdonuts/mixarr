...
- **Server-side pagination for subscription results**: `GET /api/subscriptions/:id/results` now defaults to 50 results per page (cap 200) with `page` and `pageSize` query params — replaces unbounded full-table loads
